...
public interface ISoftFluidProvider {
    ...
    Pair<SoftFluid, CompoundTag> getProvidedFluid(Level level, BlockState state, BlockPos pos);

    void consumeProvidedFluid(Level level, BlockState state, BlockPos pos, SoftFluid f, CompoundTag nbt, int amount);
